...
export default function ProjectsPage() {
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1.5fr 1fr 0.8fr 1fr", gap: "12px", padding: "12px 16px", borderRadius: "10px 10px 0 0", background: "rgba(139,92,246,0.06)", border: "1px solid rgba(139,92,246,0.12)", borderBottom: "none" }}>
      ...
      {loading ? (
        <div style={{ padding: "40px", textAlign: "center", color: "#6B7280", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(139,92,246,0.08)", borderTop: "none" }}>Loading projects...</div>
      ) : filtered.length === 0 ? (
        <div style={{ padding: "40px", textAlign: "center", color: "#4B5563", fontSize: "0.9rem", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(139,92,246,0.08)", borderTop: "none" }}>No projects found.</div>
      ) : (
        <div style={{ display: "flex", flexDirection: "column" }}>
          {filtered.map((p) => {
            ...
            return (
              <div key={p.id} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(139,92,246,0.08)", borderTop: "none", cursor: "pointer" }} onClick={() => setExpandedId(isExpanded ? null : p.id)}>
                <div style={{ display: "grid", gridTemplateColumns: "2fr 1.5fr 1fr 0.8fr 1fr", gap: "12px", padding: "14px 16px", alignItems: "center" }}>
