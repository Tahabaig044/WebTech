...
const fallbackCategories = ["Web Development", "SEO", "Google Ads", "Managed Hosting", "ERP / Automation", "Industry SaaS Suite", "Other"];
...
export default function ContactForm({ categories }: { categories: string[] }) {
  ...
  const serviceOptions = categories.length > 0 ? categories : fallbackCategories;
    ...
    <>
      ...
      <section style={{ padding: "60px 0", background: "linear-gradient(135deg, #060D19 0%, #0F2B5C 100%)", borderTop: "1px solid #1E3A8A" }}>
        <div className="wrap" style={{ textAlign: "center" }}>
          ...
          <a href="https://wa.me/923112980115" target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ padding: "14px 32px", fontSize: "1rem", background: "linear-gradient(135deg, #25D366, #075E54)" }}>
            💬 Chat on WhatsApp →
          </a>
        </div>
      </section>
